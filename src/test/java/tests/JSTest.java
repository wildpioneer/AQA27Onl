...
public class JSTest extends BaseTest {
    ...
    public void frameTest() throws InterruptedException {
        ...
        WebElement menuItem = waitsService.presenceOfElementLocated(By.id("ui-id-2"));

        JavascriptExecutor jsExecutor = (JavascriptExecutor) driver;

        jsExecutor.executeScript("arguments[0].scrollIntoView(true);", menuItem);
        //jsExecutor.executeScript("document.getElementById('ui-id-2').scrollIntoView(true);");
